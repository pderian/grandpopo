...
###
ROOTESTIMDIR = "/Users/pderian/Documents/Data/GrandPopo/drone/halfres/estim_median"
ROOTIMGDIR = "/Users/pderian/Documents/Data/GrandPopo/drone/halfres/"
...
def tracer(estimlist, imglist=None, masklist=None, outdir=None, pColor=None, title_prefix='', k0=0):
    ...
    pNum = 100
    seed = 19850131
    pDomain = (200., 150., 1100., 370.)
    pInit = (960., 200., 1000., 350.)
    #initialize...
...
#         masklist = [edir('average/{:03d}_avg_Mask.png'.format(k)) for k in xrange(imin, imax)]
        ...
        tracer(estimlist, imglist, masklist, outdir=edir('advect_movie'), k0=imin, title_prefix='Typhoon estimates, instant fields - ')
